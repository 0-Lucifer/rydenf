        ...
        content: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.check_circle_rounded, color: kGreen, size: 32),
            ),
            const SizedBox(height: 20),
            Text(
              'Complete Ride?',
            ...
            Text(
              ...
              style: GoogleFonts.plusJakartaSans(
                fontSize: 14, fontWeight: FontWeight.w500, color: kTextSecondary, height: 1.5,
              ),
            ),
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: Text('Not Yet', style: GoogleFonts.plusJakartaSans(
                ...
                child: SizedBox(
                  ...
                  child: DecoratedBox(
                    ...
                    child: TextButton(
                      ...
                      child: Text('Complete', style: GoogleFonts.plusJakartaSans(
